                ...
                <div class="lgx-footer-area footer-custom-menu">
                    <div class="lgx-footer-single">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a class="col-grey" href="{{ route('eventmie.page', ['page' => 'pricing']) }}">@lang('eventmie-pro::em.pricing')</a></li>
                            <li><a class="col-grey" href="{{ route('eventmie.page', ['page' => 'sell_tickets']) }}">@lang('eventmie-pro::em.sell_tickets')</a></li>
                        </ul>
